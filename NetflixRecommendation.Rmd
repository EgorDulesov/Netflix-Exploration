...
```{r include = FALSE}
load(file="~/shared/minor2_2019/2-tm-net/project/data/movies_data/data32.rda")
```
...
```{r}
load(file="~/shared/minor2_2019_32/movies2.rda") #это исходный датасет, соединённый с дополнительными данными
```
...
+ Если фильм доступен только на английском, то, скорее всего, он не очень популярен. Если бы у него была достаточно большая английская аудитория, то его бы перевели и на другие языки.
